    ...
    <section className="message-section">
      ...
      >
        ...
        <h2 className="message-title">
          <span className="message-lead">الي فلاولتي العزيزه 😂❤️</span>
          <span className="signature">ياسمين ❤️</span>
        </h2>
        ...
        >
          ...
          من 14/11/2020 وأنا كل شوية باكتشف حاجة جديدة تخليني أحبك أكتر.
        ...
        >
          بحبك يا ياسمين بجد، وربنا يخليكي ليا ويفضل يضحكك طول عمرك ❤️🌹
        </motion.p>
      </motion.div>
    </section>
  )
